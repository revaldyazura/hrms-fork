		...
		report.page.add_inner_button("Export Individual Report", function () {
			let dialog = new frappe.ui.Dialog({
				...
				primary_action(values) {
					...
					window.open(
						`/api/method/hrms.hr.report.report_evaluation.report_pic_subtask.export_evaluation_with_average?filters=${encoded_filters}`
					);
			...
			// if (!filters.pic_subtask || !filters.from_date || !filters.to_date) {
			// 	frappe.msgprint({
			// 		title: __("Missing Filter"),
			// 		message: __("Please select <b>PIC SubTask</b>, <b>From Date</b>, and <b>To Date</b> before exporting."),
			// 		indicator: 'red'
			// 	});
			// 	return;
			// }
